...
class RemoteConnection(object):
    ...
    def _request(self, method, url, body=None):
        ...
        # self.bootstrap.send_command("action", {"action":"pressKeyCode", "params":{"keycode":3, "metastate": None}})
        data = self.bootstrap.send_command("action",
                                           {"action": "pressKeyCode", "params": {"keycode": 3, "metastate": None}})
        try:
