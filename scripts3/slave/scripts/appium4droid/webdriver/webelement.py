...
from appium4droid.webdriver.common.by import By
from appium4droid.webdriver.common.keys import Keys
...
class WebElement(object):
    ...
    def __repr__(self):
        return '<{0.__module__}.{0.__name__} (element="{1}")>'.format(
            type(self), self._id)
    ...
    def flick(self, xoffset, yoffset, speed):
        ...
        return self._execute(Command.FLICK_ELEMENT, flickOtp)
